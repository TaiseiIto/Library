...
main =
 ...
 in do
  ...
  putStrLn . ("Dynamics.planevecarg plane_a vector_a = " ++) . show $ Dynamics.planevecarg plane_a vector_a
  putStrLn . ("Dynamics.vecplanearg vector_a plane_a = " ++) . show $ Dynamics.vecplanearg vector_a plane_a
  putStrLn . ("Dynamics.planearg plane_a plane_b = " ++) . show $ Dynamics.planearg plane_a plane_b
